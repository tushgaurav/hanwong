    ...
    <main>
      ...
      <section className="bg-[var(--card)] py-16 px-4">
        <div className="max-w-[90rem] mx-auto px-4 text-center">
          ...
          <p className="max-w-2xl mx-auto text-[var(--muted)] text-lg mb-12">
        ...
        <div className="max-w-[90rem] mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[var(--muted)] text-lg mb-8">Founder & Director, Han Wong International</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="border border-[var(--border)] p-4 rounded-md">
                  ...
                  <div className="text-[var(--muted)] text-sm">Years Teaching</div>
                </div>
                <div className="border border-[var(--border)] p-4 rounded-md">
                  <div className="text-2xl font-black text-[var(--primary)]">10,000+</div>
                  <div className="text-[var(--muted)] text-sm">Students Trained</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[90rem] mx-auto px-4">
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-6 mb-12">
            <div className="border border-[var(--border)] bg-white p-6 rounded-md text-center">
              ...
              <div className="text-[var(--muted)] text-sm">Donated to Charity</div>
            </div>
            <div className="border border-[var(--border)] bg-white p-6 rounded-md text-center">
              <div className="text-4xl font-black text-[var(--primary)] mb-2">1,000+</div>
              <div className="text-[var(--muted)] text-sm">Lives Impacted</div>
            </div>
            <div className="border border-[var(--border)] bg-white p-6 rounded-md text-center">
              <div className="text-4xl font-black text-[var(--primary)] mb-2">15+</div>
              <div className="text-[var(--muted)] text-sm">Countries Reached</div>
            </div>
            <div className="border border-[var(--border)] bg-white p-6 rounded-md text-center">
              <div className="text-4xl font-black text-[var(--primary)] mb-2">100%</div>
              <div className="text-[var(--muted)] text-sm">Fees to Charity</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-12">
            ...
            <div>
              ...
              <p className="mb-4 text-[var(--muted)] leading-[1.8]">
              ...
              <ul className="list-none p-0">
                {[
                  ...
                  <li key={index} className="flex items-start gap-2 mb-3 text-[var(--muted)]">
